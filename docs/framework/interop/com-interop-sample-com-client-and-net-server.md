...
description: 阅读代码示例，该示例显示了执行抵押计算的 COM 客户端和 .NET 服务器之间的互操作。
ms.date: 03/30/2017
dev_langs:
- csharp
- vb
...
ms.locfileid: "96282920"
---
# <a name="com-interop-sample-com-client-and-net-server"></a><span data-ttu-id="30377-103">COM 互操作示例：COM 客户端和 .NET 服务器</span><span class="sxs-lookup"><span data-stu-id="30377-103">COM Interop Sample: COM Client and .NET Server</span></span>

<span data-ttu-id="30377-104">此示例演示 [COM 客户端](#cpconcominteropsamplecomclientnetserveranchor1) 和执行抵押计算的 [.NET 服务器](#cpconcominteropsamplecomclientnetserveranchor2)的互操作。</span><span class="sxs-lookup"><span data-stu-id="30377-104">This sample demonstrates the interoperation of a [COM Client](#cpconcominteropsamplecomclientnetserveranchor1) and a [.NET Server](#cpconcominteropsamplecomclientnetserveranchor2) that performs mortgage calculations.</span></span> <span data-ttu-id="30377-105">在本示例中，客户端创建并调用托管 `Loan` 类的实例，将四个参数（其中一个等于零）传递给该实例，并显示计算结果。</span><span class="sxs-lookup"><span data-stu-id="30377-105">In this example, the client creates and calls an instance of the managed `Loan` class, passes four arguments (one of those four being equal to zero) to the instance, and displays the computations.</span></span> <span data-ttu-id="30377-106">本示例中的代码例子将贯穿本节。</span><span class="sxs-lookup"><span data-stu-id="30377-106">Code examples from this sample appear throughout this section.</span></span>  
  
<a name="cpconcominteropsamplecomclientnetserveranchor1"></a>

## <a name="com-client"></a><span data-ttu-id="30377-107">COM 客户端</span><span class="sxs-lookup"><span data-stu-id="30377-107">COM Client</span></span>  
...
## <a name="net-server"></a><span data-ttu-id="30377-108">.NET 服务器</span><span class="sxs-lookup"><span data-stu-id="30377-108">.NET Server</span></span>  
...
## <a name="see-also"></a><span data-ttu-id="30377-109">请参阅</span><span class="sxs-lookup"><span data-stu-id="30377-109">See also</span></span>

- [<span data-ttu-id="30377-110">向 COM 公开 .NET Framework 组件</span><span class="sxs-lookup"><span data-stu-id="30377-110">Exposing .NET Framework Components to COM</span></span>](exposing-dotnet-components-to-com.md)
