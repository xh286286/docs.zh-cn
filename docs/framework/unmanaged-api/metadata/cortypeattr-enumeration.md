...
|`tdSerializable`|<span data-ttu-id="7b3ce-129">指定该类型是可序列化的。</span><span class="sxs-lookup"><span data-stu-id="7b3ce-129">Specifies that the type is serializable.</span></span>|  
