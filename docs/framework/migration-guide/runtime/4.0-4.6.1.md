...
description: 在从 .NET Framework 4.0 迁移到 4.6.1 时，查找有关运行时更改导致的应用程序兼容性问题的信息，这些问题可能会影响你的应用。
ms.date: 07/10/2019
ms.assetid: 32fe4dc4-4eff-4f6d-8626-beca70135d0f
author: chlowell
ms.openlocfilehash: 276d95830f28b01a9820d745b3a5777315d44cfc
ms.sourcegitcommit: 81f1bba2c97a67b5ca76bcc57b37333ffca60c7b
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 12/10/2020
ms.locfileid: "97009366"
---
