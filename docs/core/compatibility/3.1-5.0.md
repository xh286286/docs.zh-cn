...
- [LastIndexOf 改进了对空搜索字符串的处理](#lastindexof-has-improved-handling-of-empty-search-strings)
...
- [TripleDES.Create 所创建实例的默认 FeedbackSize 值已更改](#default-feedbacksize-value-for-instances-created-by-tripledescreate-changed)
...
- [TextFormatFlags.ModifyString 已过时](#textformatflagsmodifystring-is-obsolete)
